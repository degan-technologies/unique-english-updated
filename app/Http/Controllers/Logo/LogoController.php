...
use App\Models\Logo\Logo; // Ensure the Logo model exists and is correctly imported

// Ensure the LogoResource class exists and is correctly imported
use App\Http\Resources\Logo\LogoResource; // Ensure this class exists in the specified namespace
use App\Models\User;
