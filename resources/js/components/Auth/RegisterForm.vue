...
<template>
    <!-- Registration Screen -->
    <div v-if="!verifyOtpNav" @click="closeRegistrationinForm()"
        ...
        <div v-if="frontLang?.lang" @click.stop
            ...
            <div class="bg-white backdrop-blur-lg h-fit p-10 rounded-2xl shadow-2xl w-full max-w-md">
                ...
                <div class="text-center">
                    ...
                    <button @click="closeRegistrationinForm"
                ...
                <form @submit.prevent="handleRegister" class="space-y-4">
                    ...
                    <button type="submit" :disabled="loading"
                        ...
                        <span class="flex flex-1 gap-2 items-center justify-center" v-if="loading">
                ...
                <div v-if="successMessage" class="mt-2 text-green-500 text-center font-semibold animate-pulse">
                    {{ successMessage }}
                </div>
                <div v-if="errorMessage" class="mt-2 text-red-500 text-center font-semibold">
                    {{ errorMessage }}
                </div>
                <div class="mt-4 text-center text-sm">
                    <p>
                        {{ frontLang.lang.haveAccount }}
                        <span @click="roteToLogin()" class="text-lime-700 hover:underline">{{ frontLang.lang.login
                        }}</span>
                    </p>
                </div>
            </div>
    ...
    <div v-else-if="otpVerified" @click="closeRegistrationinForm()"
        ...
        <div @click.stop
            ...
            <div class="flex justify-center space-x-2 mb-6">
                <input v-for="(digit, index) in otp" :key="index" :id="`otp-${index}`" v-model="otp[index]" type="text"
                    ...
                    @input="focusNext(index, $event)" @keydown.backspace="
                        index > 0 && !otp[index]
                            ? document
