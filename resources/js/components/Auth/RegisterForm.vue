...
<template>
    <div @click="closeRegistrationForm"
        ...
        <div @click.stop
            ...
            <div class="  p-6 text-lime-700">
                <h2 class="text-2xl font-bold">
                    {{ frontLang?.lang?.startjourneywithus || 'Start your journey with us' }}
                </h2> 
            </div>
            ...
            <div class="p-6 space-y-4">
                <form @submit.prevent="handleRegister" class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" id="name" v-model="name" placeholder="John Doe"
                                required
                                class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-lime-500 focus:border-transparent transition-all duration-200" />
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="terms" class="font-medium text-gray-700">
                                ...
                                <a href="#" class="text-lime-600 hover:text-lime-700 hover:underline">
                                    {{ frontLang?.lang?.termsAndConditions || 'Terms and Conditions' }}
                                </a>
                            </label>
                        </div>
                    </div>
                    ...
                    <button type="submit" :disabled="loading"
                        class="w-full flex justify-center items-center gap-2 bg-lime-600 hover:bg-lime-700 text-white font-medium py-3 px-4 rounded-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-lime-500 focus:ring-offset-2 disabled:opacity-70 disabled:cursor-not-allowed shadow-md hover:shadow-lg">
                        <span v-if="loading" class="flex items-center">
                            ...
                            {{ frontLang?.lang?.CreatingAccount || 'Creating Account...' }}
                        </span>
                        <span v-else>
                ...
                <transition name="fade">
                    <div v-if="errorMessage" class="p-3 bg-red-50 text-red-700 text-sm rounded-lg flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20"
                            fill="currentColor">
                            <path fill-rule="evenodd"
                ...
                <div class="text-center text-sm pt-2">
                    <p class="text-gray-600">
                        {{ frontLang?.lang?.haveAccount || 'Already have an account?' }}
                        <button @click="routeToLogin"
                            class="text-lime-600 hover:text-lime-700 hover:underline font-medium focus:outline-none">
