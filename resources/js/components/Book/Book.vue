    ...
    <div class="p-4 sm:p-6 lg:p-8 bg-gray-100 min-h-screen" id="books">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div
                v-for="book in books"
                :key="book.id"
                class="relative p-4 bg-white rounded-lg shadow hover:shadow-lg transform transition-transform duration-300 cursor-pointer flex flex-col"
            >
                ...
                <div class="p-4 flex flex-col">
                    ...
                    <div class="h-fit bottem-0">
                        ...
                        >
                            ...
                            >
                                <i
                                    class="fa-solid fa-cart-plus mb-2 material-icons right-8 text-lime-700 rounded-full p-3 hover:text-lime-700"
                                ></i>
                            </button>
                            <button
                                v-else
