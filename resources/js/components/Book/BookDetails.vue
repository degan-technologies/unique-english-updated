    ...
    <div>
        ...
        >
            ...
            >
                    ...
                    <div class="bg-white pt-2 py-8 rounded-b-lg">
                        <div class="text-left mb-6">
                            <div class="flex items-left justify-between">
                                <h2
                                    class="text-3xl text-slate-600 font-semibold"
                                >
                                    Book Description
                                </h2>
                            </div>
                ...
                <div
                    class="w-full border border-e-gray-300 h-1/2 min-h-fit rounded-lg p-6"
                >
                    <button
                        v-if="selectedbook"
                    ...
                    <div class="flex flex-row gap-4 my-2">
                        <i
                            class="fa-solid self-center fa-check text-lime-700 text-lg"
                        ></i>
                        <p class="text-gray-600 text-lg">
                            <span class="font-bold pr-4">Author:</span
                            >{{ selectedbook?.auther }}
                        </p>
                    </div>
                    <div class="flex flex-row gap-4 my-2">
                        ...
                        ></i>
                        <p class="text-gray-600 text-lg">
                            <span class="font-bold pr-4">Language:</span
                    ...
                    <div class="flex flex-row gap-4 my-2">
                        ...
                        ></i>
                        <p class="text-gray-600 text-lg">
                            <span class="font-bold pr-4">File Format:</span
                            >{{ selectedbook?.file_format }}
                        </p>
                    </div>
                    <div class="flex flex-row gap-4 my-2">
                        <i
                        ...
                        ></i>
                        <p class="text-gray-600 text-lg">
                            <span class="font-bold pr-4">Publish Date:</span
                    ...
                    <div class="flex flex-row gap-4 my-2">
                        ...
                        ></i>
                        <p class="text-gray-600 text-lg">
                            <span class="font-bold pr-4">Original Price:</span
                            >{{ selectedbook?.price }} Birr
                        </p>
                    </div>
                    <div
                        v-if="selectedbook?.discount"
                    ...
                    >
                        ...
                        ></i>
                        <p class="text-gray-600 text-lg">
                            <span class="font-bold pr-4">Discount Price:</span
                            >{{ selectedbook?.discount }} Birr
                        </p>
                    </div>
                    <div class="flex flex-row gap-4 my-2">
                        <i
                        ...
                        ></i>
                        <p class="text-gray-600 text-lg">
                            <span class="font-bold pr-4">Page Numbers:</span
                            >{{ selectedbook?.page_number }}
                        </p>
                    </div>
                    <div class="flex flex-row gap-4 my-2">
                        <i
                        ...
                        ></i>
                        <p class="text-gray-600 text-lg">
                            <span class="font-bold pr-4">Edition:</span
                            >{{ selectedbook?.eddition }} Birr
                        </p>
                    </div>
                </div>
            </div>
