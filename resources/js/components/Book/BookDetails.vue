...
// New state to control PDF viewer display
...
// When "Continue Reading" is clicked, display the PDF viewer component if file_url exists
function changeTabTemporaryFunction(slug) {
    if (selectedbook.value?.file_url) {
        // Instead of opening the PDF in a new tab, show the PDF viewer component
        ...
        <div v-else-if="selectedbookslug" class="p-6 mt-24 pb-16 rounded-lg bg-slate-50">
            <div class="grid w-[90%] mx-auto grid-cols-1 md:grid-cols-[2fr_1fr] gap-8 relative">
                ...
                <div class="w-full border border-e-gray-300 h-1/2 min-h-fit rounded-lg p-6">
                    <button @click="changeTabTemporaryFunction(selectedbook.slug)"
                    ...
                    <div class="flex flex-row gap-4 my-2">
                        ...
                        <p class="text-gray-600 text-lg"><span class="font-bold pr-4">Author:</span>{{
                    ...
                    <div class="flex flex-row gap-4 my-2">
                        <i class="fa-solid self-center fa-check text-lime-700 text-lg"></i>
                        <p class="text-gray-600 text-lg"><span class="font-bold pr-4">Original Price:</span>{{
                            selectedbook?.price }} Birr</p>
                    </div>
                    <div v-if="selectedbook?.discount" class="flex flex-row gap-4 my-2">
                        <i class="fa-solid self-center fa-check text-lime-700 text-lg"></i>
                        <p class="text-gray-600 text-lg"><span class="font-bold pr-4">Discount Price:</span>{{
                    ...
                    <div class="flex flex-row gap-4 my-2">
                        <i class="fa-solid self-center fa-check text-lime-700 text-lg"></i>
                        <p class="text-gray-600 text-lg"><span class="font-bold pr-4">Edition:</span>{{
