...
showPopularBooks.value =
    route.query.selectedAction === "details" ? true : false;
...
const toggleBookView = () => {
    if (bookViewMode.value === "auto") {
        bookViewMode.value =
            computedbookViewMode.value === "card" ? "table" : "card";
    } else {
    ...
    <div class="max-w-full mx-auto">
        ...
        <div v-else>
            ...
            >
                <!-- analatics dashboard -->
                <div
                    class="w-full bg-white py-2 rounded-lg space-y-0 flex flex-wrap items-center justify-between"
                >
                    <!-- Skill Level Dropdown -->
                    <div class="flex flex-row gap-8">
                        <div class="flex items-center px-3 py-2 rounded">
                            <p class="text-xs font-medium text-gray-600 mr-1">
                                Total {{ props?.activeTab }}
                            </p>
            ...
            <div v-if="booksAdmin.length === 0" class="text-gray-500">
                No books available.
            </div>
            <div v-if="!selectedbook && !showPopularBooks" class="pt-3">
                ...
                <div v-if="computedbookViewMode === 'table'">
                    <div
                        v-if="filteredBooksAdmin.length > 0"
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        />
                                        <h3
                                            class="text-sm font-semibold text-gray-800 truncate max-w-[30ch]"
                                        >
                                            {{ book.title }}
                                        </h3>
                                    </td>
                                    ...
                                    >
                                        <div class="flex h-full gap-2">
                                            ...
                                            <div
                                                class="bg-white border border-gray-100 rounded-md p-1 relative"
                                            >
                                                <button
        ...
        <div>
            <BookDetail
                class="bg-white"
                v-if="showPopularBooks && selectedbook"
                :selectedbook="selectedbook"
                :goBack="goBack"
            />
        </div>
