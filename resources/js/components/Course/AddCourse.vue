<script setup>
    ...
    import { onUnmounted, ref, watch , toRaw   } from 'vue';
            ...
            <div class="w-full max-w-5xl bg-white rounded-lg p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div class="md:col-span-3 space-y-6">
                        <div>
                            <label class="block text-gray-700 font-semibold mb-2">Course Name <span class="text-red-500">*</span>
                            </label>
                            <input
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <div v-if="course.create_thumbnail_url || course?.thumbnail_url">
                                    <img
                                        :src="course.create_thumbnail_url ? course.create_thumbnail_url : course?.thumbnail_url"
                            ...
                            <div>
                                <div v-if="course.create_intro_video || course?.intro_video">
                                    <iframe 
                                        :src="course.create_intro_video ? course.create_intro_video : course?.intro_video  + '?autoplay=1'" 
                    ...
                    <div class="space-y-6">
                        ...
                        <p v-if="errors.tag" class="mt-1 text-red-500 text-sm">{{ errors.tag }}</p>
                        </div>
                        <div>
                            ...
                            <p v-if="errors.skill_level" class="mt-1 text-red-500 text-sm">{{ errors.skill_level }}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="e.g. 3" />
                            <p v-if="errors.credit_hour" class="mt-1 text-red-500 text-sm">{{ errors.credit_hour }}</p>
                        </div>
                        <div>
