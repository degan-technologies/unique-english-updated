            ...
            <div v-if="collapsModuleId == courseModule.id" class="mt-2">
                <ul class="list-none pl-0">
                    ...
                    >
                        ...
                        >
                            <i
                                ...
                                class="fa-solid text-lg w-5 h-5"
                            ></i>
                        </div>

                        <!-- Lesson title -->
                        <div class="w-full">
                            <span class="self-senter">{{
                                courseContent.title
                            }}</span>
                            <div
                            ...
                            >
                                <div>
                                    <p
                                        class="text-sm font-normal text-blue-700 py-1"
                                    >
                                        {{
                    ...
                    >
                        ...
                        <div
                            class="w-6 h-6 flex items-center self-center justify-center"
                        >
                            <input
                                type="checkbox"
                                :checked="qMetaData.is_completed"
                                class="w-5 h-5 rounded border-gray-300 text-lime-600 focus:ring-lime-500 cursor-pointer"
                                @click.stop
                                readonly
                            />
                        ...
                        >
                            <i
                                class="fa-solid fa-clipboard-list text-lg w-5 h-5"
                            ></i>
                        </div>
