        ...
        <div class="w-full mx-auto sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden mb-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 p-6">
                    ...
                    <div
                        class="relative rounded-lg max-w-full overflow-hidden bg-gray-100 aspect-video"
                    >
                        <template
                            v-if="
                                selectedCourse?.intro_video_url &&
                                selectedCourse?.video_optimized
                            "
                        >
                            <VueVideoPlayer
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                ...
                <div class="p-6">
                    <div v-if="courseModules.length > 0">
                        ...
                        <div
                            class="w-full overflow-x-auto scrollbar sm:overflow-hidden"
                        >
                            <div class="w-fit md:w-full space-y-4">
                                ...
                                >
                                    <div class="flex flex-row">
                                        <!-- Module Header -->
                                        <div
                                            class="flex items-center flex-grow justify-between p-4 cursor-pointer group"
                                        ...
                                        >
                                            ...
                                            >
                                                <div
                                                    class="bg-yellow-100 p-2 rounded-lg mr-4 text-yellow-600"
                                                >
                                                    <i
                                                        class="fas fa-folder text-lg"
                                                    ></i>
                                                </div>
