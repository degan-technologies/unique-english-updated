...
<template>
    <div class="my-4 border w-full p-4">
        ...
        <div v-if="!editingContent"
            ...
            <div class="relative w-full max-w-3xl mx-auto aspect-video lg:max-h-[400px]">
                <div v-if="!isPlaying" class="absolute inset-0 cursor-pointer" @click="isPlaying = true">
                ...
                <div v-else class="absolute inset-0 w-full h-full rounded-md shadow-md">
            ...
            <form class="grid grid-cols-1 md:grid-cols-4 gap-3 ">
                ...
                <div class="col-span-2 flex justify-end space-x-3">
                    <button
                        ...
                        {{ props.selectedContent ? 'Update' : 'Add Content' }}
                    </button>
                    <button 
                        type="button" 
                        @click="cancelEdit()" 
