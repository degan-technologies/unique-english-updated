        ...
        <div class="grid grid-cols-1 md:grid-cols-3">
            ...
            <div class="col-span-1 bg-gray-50 p-4 shadow-md">
                <div class="flex justify-between items-center border-b pb-2 mb-4">
                    ...
                    <i @click="toggleNewTest"
                        class="fa-solid fa-plus text-lg text-gray-800 cursor-pointer"
                        title="New Test"></i>
                </div>
                <div v-for="(test, index) in paginatedTests"
                    :key="test.id"
                    class="mb-2">

                    <div class="flex items-center justify-between p-2 bg-gray-100 rounded hover:bg-gray-200 cursor-pointer"
                        ...
                        <div>
                            ...
                            <h3 class="text-sm font-medium">
                                ...
                                {{ test.question.slice(0, 50) }}{{ test.question.length > 50 ? "..." : "" }}
                            </h3>
                        </div>

                        <!-- Delete icon only visible if the test is selected -->
                        <div v-if="selectedTest && selectedTest.id === test.id"
                            class="flex items-center space-x-2">
                            <button @click.stop="openDeleteModal(test)"
                ...
                <!-- Pagination Controls -->
                <div v-if="tests.length > itemsPerPage"
            ...
            <div class="col-span-1 md:col-span-2 bg-gray-50 p-4 shadow-md">
                ...
                <form v-if="openCollapse"
                    ...
                    <div>
                        ...
                        <div v-for="(choice, index) in metaData.choices"
                            :key="index"
