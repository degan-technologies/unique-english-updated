...
<template>
    <div class="min-h-screen bg-gray-50 py-6 px-4 sm:px-6 lg:px-8">
        <!-- Live Stream View -->
        <div v-if="selectedRoom" class="fixed inset-0 z-50 flex items-center justify-center bg-white animate-fadeIn">
            <div class="relative w-full h-full">
                <JetsiLive :selectedRoom="selectedRoom" @closeStream="selectedRoom = false" />
            </div>
        </div>
