    ...
    >
        ...
        <div class="mb-8">
            <input
                v-model="newQuestion"
                type="text"
                class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-lime-400 mb-4 transition duration-300"
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <div>
                        <div
                            class="bg-lime-100 text-gray-800 p-3 rounded-lg shadow-md transition-transform duration-300 ease-in-out"
                        >
                            {{ answer.text }}
                        </div>
                        <button
