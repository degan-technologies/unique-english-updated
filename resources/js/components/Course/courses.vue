                                    ...
                                    <div class="relative">
                                        ...
                                        <div
                                            ...
                                            <button 
                                                ...
                                                class="w-full px-2 py-1.5 text-left text-black hover:bg-blue-100 transition">
                                                Edit
                                            </button>
                                            <button 
                                                @click="deleteCourse(course.id)" 
                                                class="w-full px-2 py-1.5 text-left text-black hover:bg-red-100 transition">
                                                Delete
                                            </button>
                                            <button 
                                                @click="openModuleForm(course.id)" 
                                                class="w-full px-2 py-1.5 text-left text-black hover:bg-purple-100 transition">
                                                Add Module
                                            </button>
                                        </div>
                                    </div>
