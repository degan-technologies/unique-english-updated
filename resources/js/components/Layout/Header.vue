...
<template>
    <header
      class="fixed  max-h-24 top-0 left-0 w-full z-10 transition-transform duration-300 ease-in-out backdrop-blur-lg bg-lime-700/75 border border-white/20 shadow-lg"
      :class="{
        'translate-y-0': isMenuVisible,
        '-translate-y-full': !isMenuVisible,
      }"
    >
      <div class="container h-fit mx-auto flex items-center justify-between">
        ...
        <div class="flex gap-4">
            ...
            <div class="relative  self-center">
                <Popper :offset-distance="'0'" placement="bottom-start">
                    ...
                    <template #content>
                    <div
                        class="absolute top-4 right-0 bg-white text-black shadow-lg w-96 h-96 overflow-y-auto scrollbar px-4 py-2 rounded"
                    >
            ...
            <!-- Login & Register Call-to-Action Buttons -->
                <div v-if="isLoggedIn" class="relative self-center">
                      ...
                      <div
                       ...
                       <div  v-if="dropDownOpen" class="bg-gray-50 absolute  top-16 right-0 text-black w-48 shadow-lg rounded p-2">
                          <ul>
                              <li>
                              <router-link
                                  to="/my-course" class="block px-2 py-2 hover:bg-gray-200 text-sm  items-center gap-2" >
              ...
              <button  class="text-white h-fit w-fit text-sm px-2 py-1 rounded-md mt-3 border-2 border-yellow-400  font-bold hover:border-yellow-600">አማርኛ</button>
