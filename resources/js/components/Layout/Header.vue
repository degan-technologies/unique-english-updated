  ...
  <header
    ...
    <div class="  h-fit mx-auto flex items-center justify-between">
      <router-link to="/" class="flex items-center gap-2">
        <img src="/images/logo.jpg" alt="Logo" class="h-12 w-12 rounded-full object-cover border-2 border-white" />
      ...
      <div class="flex gap-4">
                ...
                <div v-else>
                  <ul>
                    <li v-for="item in items" :key="item.id"
                      ...
                      <i @click="removeItem(item)" class="fa-solid fa-minus text-red-500 hover:text-red-700"></i>
                    </li>
                  </ul>
        ...
        <div v-if="isLoggedIn" class="relative self-center">
          ...
          <div v-if="dropDownOpen" class="bg-gray-50 absolute  top-16 right-0 text-black w-48 shadow-lg rounded p-2">
            <ul>
              <li>
                <router-link to="/my-course" class="block px-2 py-2 hover:bg-gray-200 text-sm  items-center gap-2">
                  <span class="block px-4 py-2 hover:bg-gray-200">My Courses</span>
                </router-link>
              </li>
              <li>
                <a href="/certificate" class="block px-2 py-2 hover:bg-gray-200 text-sm  items-center gap-2">
