<template>
      ...
      <header class="bg-white shadow p-4 flex flex-col md:flex-row justify-between items-center">
        ...
        <nav class="mt-2 md:mt-0">
          <ul class="flex space-x-4">
            <li>
              <button
                class="px-4 py-2 rounded hover:bg-blue-600 transition-colors"
            ...
            <li>
              <button
                class="px-4 py-2 rounded hover:bg-green-600 transition-colors"
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4 p-4">
        ...
        <main class="md:col-span-2 bg-white rounded shadow p-4 flex flex-col">
          ...
          <section class="mt-4 flex-1 flex flex-col">
            ...
            <div
              class="flex-1 overflow-y-auto border rounded p-2 bg-gray-50"
              ref="chatContainer"
            >
            ...
            <div class="mt-2 flex">
              ...
              />
              <button
                class="bg-blue-500 text-white px-4 rounded-r hover:bg-blue-600 transition-colors"
          ...
          <div class="mb-4">
            <div class="flex space-x-2 mb-2">
              <button
                ...
                @click="activeEngagementTab = 'poll'"
              >
                Poll
              </button>
              <button
  ...
  <script>
  export default {
    name: "LiveSessionsPanel",
    data() {
      return {
        // Navigation state
        activeTab: "live", // live, upcoming, recorded
        // Session list (demo data)
        sessions: [
          {
            id: 1,
            title: "Math 101",
        ...
        newChatMessage: "",
        // Engagement tab state (poll or qa)
        activeEngagementTab: "poll",
        // Poll module data
        currentPoll: {
        ...
        newQuestion: "",
        // Scheduling modal & new session data
    ...
    methods: {
      ...
      totalPollVotes() {
        return this.currentPoll.options.reduce(
      ...
      scheduleSession() {
        // Demo: add new session to sessions list
        this.sessions.push({
          id: Date.now(),
          title: this.newSession.title,
          instructor: "You",
          startTime: new Date(this.newSession.dateTime).toLocaleTimeString(),
          status: "scheduled",
          participants: 0,
        });
        // Reset new session form and close modal
        this.newSession = { title: "", dateTime: "", duration: 60 };
