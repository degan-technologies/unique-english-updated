    ...
    <div class="sticky top-0 z-40">
        ...
        >
            <div class="flex items-center">
                <button
                    class="md:hidden text-gray-600 hover:text-lime-500 transition-colors duration-300"
                    @click="toggleSidebar"
                ...
                <div v-if="isLoggedIn" class="relative flex justify-center">
                    ...
                    >
                        ...
                        >
                            <div class="relative">
                                <i
                                    class="fa-solid fa-bell text-2xl text-lime-500"
                                ></i>
                                <span
    ...
    >
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
            ...
            <div class="p-4" v-if="currentNotification">
                <h1 class="text-gray-600 my-2 font-bold">
