...
function submitAnnouncement() { 
    ...
    Axios
        .post('/api/email-notification', data)
        .then(res => {
                ...
                <div class="bg-white rounded col-span-1 shadow p-4">
                    ...
                    <ul class="divide-y divide-gray-200 max-h-96 overflow-y-auto">
                        <li v-for="(announcement, index) in announcements" 
                            ...
                            <div>
                                <p class="font-medium">{{ announcement.subject }}</p>
                ...
                <div class="bg-white col-span-2 rounded shadow p-4">
                    ...
                    <form>
                        <div class="mb-4">
                            ...
                            <input type="text" v-model="newAnnouncement.subject" placeholder="Enter announcement title"
                                class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-300"
                                required />
                        </div>
                        <div class="mb-4">
                            <label class="block text-gray-700 mb-1">Message</label> 
                            <textarea v-model="newAnnouncement.message" placeholder="Enter your message"
