...
const fetchUsers = async (page = 1) => {
    try {
        const res = await Axios.get(
            `/api/my-private-students-schedule?page=${page}`,
            {
                params: {
                ...
                <div class="w-full min-w-[800px]" v-if="users.length">
                    ...
                    <div class="divide-y divide-gray-200 bg-white">
                        ...
                        >
                            <!-- Main User Row -->
                            <div
                                class="grid grid-cols-12 items-center px-6 py-4 cursor-pointer transition-all duration-150"
                                :class="{
                            ...
                            >
                                ...
                                >
                                    <i
                                        ...
                                        class="fa-solid text-lime-700 text-sm"
                                    ></i>
                                    <img
                                        :src="
                                            user.profile ||
                                    ...
                                    <div class="flex flex-col">
                                        <h1
                                            class="text-sm font-medium capitalize text-gray-900"
                                        >
                                            {{ user.first_name }}
                                            {{ user.middle_name }}
                                        </h1>
                                ...
                                <div class="col-span-3 flex items-center">
                                    <button
                                        @click.stop="onAddSchedule(user.id)"
                            ...
                            <div
                                ...
                                class="w-full bg-gray-50 transition-all duration-200"
                            >
                                <div v-if="user.mySchedules?.length">
                                    <table class="w-full">
                                        ...
                                        >
                                            ...
                                            >
                                                <td
                                                    class="px-6 py-4 whitespace-nowrap text-sm flex flex-row text-gray-500 gap-2"
                                                >
                                                    <p>{{ index + 1 }},</p>
                                                    <span>{{
                                                        session.day
                                ...
                                <div
                                    v-else
                                    class="px-6 py-3 text-center text-gray-500 text-sm"
                                >
