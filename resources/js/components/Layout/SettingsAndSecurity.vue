...
function storeOrUpdate() {
    ...
    Axios.post("/api/hero-section", formData).then((res) => {
            ...
            <main class="flex-1">
                    ...
                    <div v-if="selectedTab === settingTab" key="theme">
                        ...
                        <div class="bg-white rounded-lg shadow p-6 mb-6">
                            ...
                            <div class="flex flex-col md:flex-row gap-6">
                                ...
                                <!-- Live Preview Panel -->
                                <div
                                    class="flex-1 relative bg-gray-50 rounded-lg shadow-inner p-4"
                                >
                                    <!-- Actions disabled -->
                                    ...
                                    <div
                                        class="z-50 my-2 h-fit w-full rounded-full justify-end right-6"
                                    >
                                        <i
                                            @click="onExpandView()"
                                            :class="{
                                            ...
                                            class="fa-solid font-bold text-2xl text-blue-600"
                                        ></i>
                                    </div>
                                </div>
                            </div>
                ...
                <transition name="fade" mode="out-in">
                    ...
                    >
                        <div class="bg-white rounded-lg shadow p-6 mb-6">
                            <div class="flex items-center mb-4">
                                <div class="text-3xl text-red-500 mr-2">🔒</div>
                                <h2 class="text-xl font-semibold">
