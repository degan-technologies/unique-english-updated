        ...
        <transition name="fade">
            <div v-if="showDeleteModal"
                ...
                <div class="bg-white rounded shadow-lg w-96 p-6">
                    ...
                    <p class="mb-6">
                        Are you sure you want to delete <strong>{{ modalUser.first_name }} {{ modalUser.middle_name
                            }}</strong>?
                    </p>
            ...
            <div v-if="showMessageModal"
                ...
                <div class="bg-white rounded shadow-lg w-96 p-6">
                    <h3 class="text-xl font-bold mb-4">
                        {{ modalUser ? 'Message ' + modalUser.first_name + ' ' + modalUser.middle_name : 'New Announcement' }}
                    </h3>
                    ...
                    <form @submit.prevent="submitAddUser">
                        ...
                        <div class="mb-6">
                            <p class="text-gray-600 text-sm">
                                A random password will be generated for this account. This account will be created as an
                                <strong>Instructor</strong> by default.
                                The generated password will be displayed in the user table until the instructor updates
                                it.
                            </p>
                        </div>
