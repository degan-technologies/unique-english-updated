...
async function fetchAllVideos() {
    try {
        ...
        if (data.error && data.error.code === 403) {
            ...
            videos.value = data.items.filter(
                (i) => i.id.kind === "youtube#video"
            );
        }
    } catch (err) {
        ...
        <div v-else class="space-y-6">
            ...
            >
                <div class="mx-auto" style="max-width: 800px">
                    ...
                    <div
                        class="text-xl my-8 font-bold md:text-2xl text-gray-800 px-1"
                    >
            ...
            <div class="space-y-4">
                ...
                >
                    ...
                    >
                        <div
                            class="relative rounded-lg overflow-hidden shadow-md border-2 transition-all"
                            :class="
                        ...
                        >
                            ...
                            >
                                <div
                                    class="w-12 h-12 rounded-full bg-lime-600/90 flex items-center justify-center"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
