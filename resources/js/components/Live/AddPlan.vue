...
<template>
    <div class="flex flex-col items-center justify-center bg-white rounded-lg w-full max-w-md sm:max-w-lg md:max-w-xl">
        <div class="bg-white shadow-lg rounded-lg p-5 w-full max-w-xl relative">
