<template>
    <div
        class="flex flex-col items-center justify-center bg-gray-100  p-2"
    >
        <!-- Add Plan Form -->
        <div class="bg-white shadow-lg rounded-lg p-5 w-full max-w-lg">
            <h1
                class="text-2xl font-bold text-lime-700 mb-6 text-center flex items-center justify-center gap-1"
            >
                Add New Plan
            </h1>
