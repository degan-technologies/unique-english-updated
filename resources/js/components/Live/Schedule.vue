    ...
    <div class="p-6 flex flex-col md:flex-row mt-24 gap-6">
        ...
        <div class="flex-[0.7]">
            ...
            <div v-else
                ...
                <div v-for="(day, index) in schedule"
                    :key="index"
                    class="p-4 rounded-lg shadow-lg bg-white border border-gray-200">
                    <h2 class="text-lg font-bold text-gray-700 text-center mb-3">
                        {{ day.name }}
                    </h2>
                    ...
                    <div v-if="day.slots.length"
                        class="space-y-3">
                        <div v-for="(slot, slotIndex) in day.slots"
                            :key="slotIndex"
        ...
        <div class="flex-[0.3] bg-white p-4 rounded-lg shadow-lg border border-gray-200 flex flex-col justify-start">
            ...
            <!-- Error Message -->
            <div v-if="error"
                class="text-red-500 text-center">{{ error }}</div>
