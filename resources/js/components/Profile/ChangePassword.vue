...
const validateForm = () => {
    ...
    if (!passwords.value.confirmPassword) {
        ...
        isValid = false;
    } else if (passwords.value.newPassword !== passwords.value.confirmPassword) {
...
const changePassword = async (e) => {
    ...
    try {
        ...
        errors.value.general = response.data.message || "Password changed successfully";
    ...
    <div class="w-full  bg-white overflow-hidden space-y-6">
        <div class="text-center">
            ...
            <p class="mt-1 text-sm text-gray-600">
                {{ frontLang?.lang?.passwordChangeDesc || 'Secure your account with a new password' }}
            </p>
        </div>
        ...
        <form @submit.prevent="changePassword" class="space-y-5">
            ...
            <div>
                ...
                <div class="relative">
                    <input v-model="passwords.oldPassword" :type="showPassword.old ? 'text' : 'password'"
                        id="current-password" autocomplete="current-password" placeholder="Enter current password"
                    ...
                    <button type="button" @click="togglePasswordVisibility('old')"
            ...
            <div>
                ...
                <div class="relative">
                    <input v-model="passwords.newPassword" :type="showPassword.new ? 'text' : 'password'"
                        id="new-password" autocomplete="new-password" placeholder="Enter new password"
                        class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-lime-500 focus:border-lime-500"
                        :class="{
            ...
            <div>
                ...
                <div class="relative">
                    <input v-model="passwords.confirmPassword" :type="showPassword.confirm ? 'text' : 'password'"
                        id="confirm-password" autocomplete="new-password" placeholder="Confirm new password"
                        class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-lime-500 focus:border-lime-500"
                        :class="{
