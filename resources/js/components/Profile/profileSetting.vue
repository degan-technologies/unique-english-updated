...
onMounted(async () => {
    try {
        ...
        if (authUser.value) {
            form.value = {
                ...authUser.value,
                full_name: `${authUser.value.first_name} ${
            ...
            <div class="relative h-48 bg-gray-200 overflow-hidden">
                ...
                <div class="absolute z-50 bottom-4 right-4 flex space-x-2">
                    <button
                        ...
                        :title="
                            frontLang?.lang?.changeBg || 'Change background'
                        "
                    >
                        <i
                            v-if="isUploading && activeField === 'bg_image'"
                    ...
                    <button
                        ...
                        :disabled="isLoading"
                        :title="
                            frontLang?.lang?.removeBg || 'Remove background'
                        "
                    >
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute -bottom-2 -right-2 flex space-x-2">
                            <button
                                ...
                                :disabled="
                                    isUploading && activeField === 'profile'
                                "
                                :title="
                                    frontLang?.lang?.changeProfile ||
                                    'Change profile'
                                "
                            >
                                <i
                                ...
                                <i
                                    v-else
                                    class="fas fa-camera text-gray-700"
                                ></i>
                            </button>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            >
                                <option value="">
                                    {{
                                        frontLang?.lang?.selectGender ||
                                        "Select gender"
                                    }}
                                </option>
                                <option value="1">
                                    {{ frontLang?.lang?.male || "Male" }}
                                </option>
                                <option value="2">
                                    {{ frontLang?.lang?.female || "Female" }}
                                </option>
                            </select>
                            <p
                                v-if="errors.gender"
