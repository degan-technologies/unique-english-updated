...
async function fetchUsers() {
    Axios
        ...
        .then(res => {
            ...
            animateValue(animatedTotalUsers, animatedTotalUsers.value, stats.value.totalUsers);
            animateValue(animatedActiveUsers, animatedActiveUsers.value,  stats.value.activeUsers );
            animateValue(animatedNewRegistrations, animatedNewRegistrations.value,  stats.value.newRegistrations);
...
<template>
    <div class="bg-white rounded-lg shadow-lg w-full p-6 relative">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6 text-center mx-auto ">
            ...
            <div class="py-2">
                <div class="text-3xl font-bold text-lime-700">{{ animatedActiveUsers == 0 ? 1 : animatedActiveUsers  }}</div>
