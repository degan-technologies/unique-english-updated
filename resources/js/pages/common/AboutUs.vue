        ...
        >
            ...
            <div class="lg:w-2/3 text-center lg:text-left">
                ...
                <button
                    ...
                    class="text-lime-700 text-sm font-semibold hover:underline hover:text-lime-800 transition-colors duration-200 block mb-6"
                >
                    See More...
                </button>
                <button
...
<style scoped>
/* Ensure proper text justification */
p {
    text-align: justify;
    hyphens: auto;
    word-spacing: normal;
